...
def _build_data_block(cfg, T, G_data, A, S):
    ...
    for m in window:
        ...
        obj = (
            ...
            f'searchContribution:{jnum(contrib["Search"],1)},digitalContribution:{jnum(contrib["Digital"],1)},'
            f'socialContribution:{jnum(contrib["Social"],1)},competitiveContribution:{jnum(contrib["Competitive"],1)},'
            f'categoryContribution:{jnum(contrib["Category"],1)},'
